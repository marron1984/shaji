/** カテゴリごとのビジュアル情報（絵文字アイコン・Unsplash写真） */

export interface CategoryMeta {
  emoji: string;
  image: string; // Unsplash URL (640px)
  description: string;
  featured?: boolean; // トップに大きく表示
}

const categoryMeta: Record<string, CategoryMeta> = {
  "01": {
    emoji: "🏠",
    image: "https://images.unsplash.com/photo-1616046229478-9901c5536a45?w=640&q=80",
    description: "お部屋の配置や色使いで運気アップ",
    featured: true,
  },
  "02": {
    emoji: "💰",
    image: "https://images.unsplash.com/photo-1579621970563-ebec7560ff3e?w=640&q=80",
    description: "お金に好かれる習慣と開運術",
    featured: true,
  },
  "03": {
    emoji: "💼",
    image: "https://images.unsplash.com/photo-1507679799987-c73779587ccf?w=640&q=80",
  ...
  "08": {
    emoji: "⛩️",
    image: "https://images.unsplash.com/photo-1478436127897-769e1b3f0f36?w=640&q=80",
